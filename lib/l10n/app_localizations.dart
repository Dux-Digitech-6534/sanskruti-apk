...
class AppLocalizations {
  ...
  String message(String value) {
    ...
    final receiptSubmitted = RegExp(
      r'^Purchase Receipt Submitted: (.+)$',
    ).firstMatch(trimmed);
    if (receiptSubmitted != null) {
      return 'परचेज रिसीट सबमिट हुई: ${receiptSubmitted.group(1)}';
    }
...
const _en = <String, String>{
  ...
  'add_item': 'Add Item',
  'add_material_receipt': 'Add Material Receipt',
  'all': 'All',
  'amount': 'Amount',
  'any': 'Any',
  'apply': 'Apply',
  ...
  'no_purchase_receipts_found': 'No purchase receipts found.',
  'no_recent_material_requests_found': 'No recent material requests found.',
  'no_recent_purchase_receipts_found': 'No recent purchase receipts found.',
  ...
  'purchase_receipt_details': 'Purchase Receipt Details',
  ...
  'submit': 'Submit',
  'submit_purchase_receipt': 'Submit Purchase Receipt',
  'submitted': 'Submitted',
  'supplier': 'Supplier',
...
const _hi = <String, String>{
  ...
  'add_material_receipt': 'मटेरियल रिसीट जोड़ें',
  'all': 'सभी',
  'amount': 'राशि',
  'any': 'कोई भी',
  'apply': 'लागू करें',
  ...
  'create_purchase_receipt': 'परचेज रिसीट बनाएं',
  'dashboard': 'डैशबोर्ड',
  'date': 'तारीख',
  'document': 'डॉक्यूमेंट',
  'draft': 'ड्राफ्ट',
  ...
  'no_purchase_receipts_found': 'कोई परचेज रिसीट नहीं मिली।',
  'no_recent_material_requests_found':
      'हाल की कोई मटेरियल रिक्वेस्ट नहीं मिली।',
  'no_recent_purchase_receipts_found': 'हाल की कोई परचेज रिसीट नहीं मिली।',
  ...
  'pending_requests': 'लंबित रिक्वेस्ट',
  ...
  'purchase_receipt': 'परचेज रिसीट',
  'purchase_receipt_details': 'परचेज रिसीट विवरण',
  'purchase_receipts': 'परचेज रिसीट',
  'qty': 'मात्रा',
  'quantity': 'मात्रा',
  ...
  'submit': 'सबमिट',
  'submit_purchase_receipt': 'परचेज रिसीट सबमिट करें',
  'submitted': 'सबमिटेड',
  'supplier': 'सप्लायर',
...
const _messageHi = <String, String>{
  ...
  'Purchase Receipt Submitted': 'परचेज रिसीट सबमिट हुई',
  'Purchase Receipt submitted successfully':
      'परचेज रिसीट सफलतापूर्वक सबमिट हुई',
  'Purchase Receipt Submitted.': 'परचेज रिसीट सबमिट हुई।',
  ...
  'This Purchase Receipt is already saved.': 'यह परचेज रिसीट पहले से सेव है।',
