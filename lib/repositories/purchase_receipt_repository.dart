...
class PurchaseOrderItemSelection {
  ...
  factory PurchaseOrderItemSelection.fromJson(Map<String, dynamic> json) {
    ...
    return PurchaseOrderItemSelection(
      ...
      rate: _rateFromJson(json, qty: qty),
    );
  }
  ...
  static double _rateFromJson(Map<String, dynamic> json, {required double qty}) {
    ...
    final amount = _firstPositive([json['amount'], json['base_amount']]);
    if (amount > 0 && qty > 0) return amount / qty;
    return 0;
  }

  static double _firstPositive(List<Object?> values) {
...
class PurchaseOrderReceiptItem {
  ...
  factory PurchaseOrderReceiptItem.fromJson(Map<String, dynamic> json) {
    final qty = _toDouble(json['qty']);
    final rate = _rateFromJson(json, qty: qty);
